...
const LoginPopup = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50">
      <div className="bg-white flex w-[700px] h-[528px] rounded-sm overflow-hidden relative shadow-2xl">
        <button 
          onClick={onClose}
          className="absolute -right-8 top-0 text-white text-3xl opacity-80 hover:opacity-100"
        >
          &times;
        </button>

        {/* Left Side: Blue Banner */}
        <div className="w-[40%] bg-[#2874f0] p-8 flex flex-col justify-between">
          <div>
        ...
        <div className="w-[60%] p-8 bg-white relative">
          <form onSubmit={handleSubmit} className="flex flex-col h-full">
            ...
            <button
              type="submit"
              className="w-full bg-[#fb641b] text-white py-3 font-medium rounded-sm shadow hover:shadow-lg transition-shadow"
            >
